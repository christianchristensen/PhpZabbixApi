 ...
 *
 * @version     $Id: abstract.tpl.php 136 2012-08-20 18:37:34Z dbarton $
 */
...
abstract class ZabbixApiAbstract
{
    ...
    public function userLdapLogin($params=array(), $arrayKeyProperty='')
    {
        // get params array for request
        $params = $this->getRequestParamsArray($params);

        // request
        return $this->request('user.ldapLogin', $params, $arrayKeyProperty);
    }
